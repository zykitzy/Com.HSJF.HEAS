...
{
    public class EmergencyContactAuditDAL : BaseRepository<EmergencyContactAudit, HEASContext>
    {
        public IEnumerable<EmergencyContactAudit> GetByPersonID(string personid)
        {
