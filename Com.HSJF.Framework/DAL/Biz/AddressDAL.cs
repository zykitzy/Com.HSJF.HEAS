...
{
    public class AddressDAL : BaseRepository<Address, HEASContext>
    {
        public override void UpdateRange(IEnumerable<Address> entityList)
        {
        ...
        public IEnumerable<Address> GetByPersonID(string personid)
        {
