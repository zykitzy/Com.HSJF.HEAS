...
{
    public class RelationPersonMap : EntityTypeConfiguration<RelationPerson>
    {
        public RelationPersonMap()
        {
            // Primary Key
            this.HasKey(t => t.ID);
            ...
            this.ToTable("RelationPerson", "biz");
            ...
            this.HasRequired(t => t.BaseCase)
                .WithMany(t => t.RelationPersons)
                .HasForeignKey(d => d.CaseID).WillCascadeOnDelete(true);
