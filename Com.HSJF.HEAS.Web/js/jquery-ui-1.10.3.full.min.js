...
$.widget( "ui.button", {
	...
	_resetButton: function() {
		...
		var buttonElement = this.buttonElement.removeClass( typeClasses ),
			...
			buttonClasses = [];
		if(this.options.label=="Close"){
			$(buttonElement).find(".ui-button-text").remove();//判断是右上角的关闭按钮时不需要此元素
		}
		if ( icons.primary || icons.secondary ) {
			...
			if ( icons.primary && this.options.label!="Close") {//判断不是关闭按钮时增加此元素
...
var dialog = $.widget( "ui.dialog", {
	...
	_createTitlebar: function() {
		...
		// dialog in IE (#9312)
		this.uiDialogTitlebarClose = $( "<a type='button'></a>" )//原先是button，因为样式问题该成a标签
			.button({
